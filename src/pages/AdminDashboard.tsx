...
<p style="margin-bottom: 0;">Immigration, Refugees and Citizenship Canada (IRCC).</p>`;
  ...
  return (
    <main className="mx-auto max-w-[1400px] w-full px-4 py-8 md:py-10 font-sans text-[#333]">
      <div className="flex justify-between items-center border-b border-gray-300 pb-4 mb-6">
        <h1 className="text-2xl md:text-3xl font-bold text-[#26374a]">Immigration Case Management</h1>
      </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          {(!selectedAppId || showSidebar) && (
            <div className={`w-full lg:w-[350px] flex-shrink-0 flex flex-col gap-6 ${selectedAppId ? 'lg:sticky lg:top-4 lg:max-h-[90vh] overflow-y-auto' : ''}`}>
              
              {/* Create Applicant Profile */}
              {!selectedAppId && (
                <div className="bg-gray-100 p-5 border border-gray-300 shadow-sm rounded-sm">
                  ...
                  <form onSubmit={handleCreateProfile} className="space-y-4 text-sm">
                    ...
                    <button type="submit" className="bg-[#26374a] text-white px-4 py-2 font-bold hover:bg-[#111820] w-full transition-colors mt-2">
                      Create Profile & Record
                    </button>
                    <p className="text-xs text-gray-600">Provide the email to the user afterwards. Initial stages will be prepared automatically.</p>
                  </form>
                </div>
              )}
